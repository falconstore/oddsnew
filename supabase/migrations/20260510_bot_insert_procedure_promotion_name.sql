-- Fix bot_insert_procedure: renomeia coluna titulo → promotion_name
-- A tabela procedures usa promotion_name; a função antiga ainda referenciava titulo
...
BEGIN
  INSERT INTO public.procedures (
    ...
    platform, category, status, tipo, prioridade,
    ...
    CASE WHEN p_data->>'freebet_reference_id' IS NOT NULL
         ...
         ELSE NULL END,
    COALESCE((p_data->'tags')::jsonb, '[]'::jsonb)::text[],
