-- =====================================================
-- Atualiza RPC `bot_insert_procedure` pra incluir `is_extra`
--
-- Sem essa mudança, o campo `is_extra` enviado pelo RegisterBotMessageModal
-- (paste manual de mensagem) seria silenciosamente ignorado pelo INSERT.
-- =====================================================
...
BEGIN
  INSERT INTO public.procedures (
    ...
    COALESCE((p_data->>'is_extra')::boolean, false)
  )
