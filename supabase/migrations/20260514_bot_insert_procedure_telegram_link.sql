-- Fix bot_insert_procedure: adiciona telegram_link no INSERT
-- O bot já enviava p_data->>'telegram_link' mas a função ignorava
-- (campo não estava na lista de colunas), então o link nunca era persistido.
