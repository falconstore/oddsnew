...
const BOOKMAKER_LEAGUES: Record<string, string[]> = {
  ...
  betano: ["Premier League", "La Liga", "Serie A", "Bundesliga"],
  estrelabet: ["Serie A"],
              ...
              {bookmakers?.map((bookmaker) => {
                ...
                return (
                  <Collapsible
                    key={bookmaker.id}
                    open={isExpanded}
                    onOpenChange={() => toggleRow(bookmaker.id)}
                    asChild
                  >
                    <>
                      <TableRow>
